...
*/}}
{{- define "whereabouts.namespaceName" -}}
{{- default .Release.Namespace .Values.namespaceOverride }}
{{- end }}
{{- define "whereabouts.namespace" -}}
namespace: {{ include "whereabouts.namespaceName" . }}
{{- end }}
...
*/}}
{{- define "whereabouts.operatorSelectorLabels" -}}
app: {{ include "whereabouts.name" . }}-operator
app.kubernetes.io/name: {{ include "whereabouts.name" . }}-operator
app.kubernetes.io/instance: {{ .Release.Name }}
{{- end }}
