...
func (t *TestJobController) GetPodFromInformerCache(namespace, name string) (metav1.Object, error) {
...
func (t *TestJobController) GetServiceFromInformerCache(namespace, name string) (metav1.Object, error) {
